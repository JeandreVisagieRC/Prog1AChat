...
public class registration {
    ...
    if (isPhoneValid) {
        ...
        System.out.println("Phone number is incorrectly formatted or " +
...
public static boolean loginUser(Scanner input, user registeredUser) {
    System.out.print("Enter Username: ");
    ...
    if (loginUsername.equals(registeredUser.getUsername()) &&
        ...
        System.out.println("Welcome back, " + loginUsername + "! Login Successful.");
        return true;
    } else {
